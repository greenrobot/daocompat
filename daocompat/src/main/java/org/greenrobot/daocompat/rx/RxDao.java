...
public class RxDao<T, K> extends RxBase {
     ...
     */
    @Experimental
    public Observable<T> load(final Long key) {
     ...
     */
    @Experimental
    public Observable<Iterable<T>> insertInTx(final Collection<T> entities) {
    ...
    /**
     * Rx version of {@link AbstractDao#insertOrReplaceInTx(Collection)} returning an Observable.
     * Note that the Observable will emit the given entities back to its subscribers.
     */
    @Experimental
    public Observable<Iterable<T>> insertOrReplaceInTx(final Collection<T> entities) {
        return wrap(new Callable<Iterable<T>>() {
            @Override
            public Iterable<T> call() throws Exception {
    ...
    /**
     * Rx version of {@link AbstractDao#saveInTx(Collection)} returning an Observable.
     * Note that the Observable will emit the given entities back to its subscribers.
     */
    @Experimental
    public Observable<Iterable<T>> saveInTx(final Collection<T> entities) {
        return wrap(new Callable<Iterable<T>>() {
            @Override
            public Iterable<T> call() throws Exception {
    ...
    /**
     * Rx version of {@link AbstractDao#updateInTx(Collection)} returning an Observable.
     * Note that the Observable will emit the given entities back to its subscribers.
     */
    @Experimental
    public Observable<Iterable<T>> updateInTx(final Collection<T> entities) {
        return wrap(new Callable<Iterable<T>>() {
            @Override
            public Iterable<T> call() throws Exception {
    ...
    /**
     * Rx version of {@link AbstractDao#deleteByKey(Long)} returning an Observable.
     */
    @Experimental
    public Observable<Void> deleteByKey(final Long key) {
        return wrap(new Callable<Void>() {
            @Override
            public Void call() throws Exception {
                dao.deleteByKey(key);
    ...
    /**
     * Rx version of {@link AbstractDao#deleteInTx(Collection)} returning an Observable.
     */
    @Experimental
    public Observable<Void> deleteInTx(final Collection<T> entities) {
        return wrap(new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    /**
     * Rx version of {@link AbstractDao#deleteByKeyInTx(Collection)} returning an Observable.
     */
    @Experimental
    public Observable<Void> deleteByKeyInTx(final Collection<Long> keys) {
        return wrap(new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    /**
     * Rx version of {@link AbstractDao#deleteByKeyInTx(Long[])} returning an Observable.
     */
    @Experimental
    public Observable<Void> deleteByKeyInTx(final Long... keys) {
        return wrap(new Callable<Void>() {
            @Override
            public Void call() throws Exception {
                dao.deleteByKeyInTx(keys);
